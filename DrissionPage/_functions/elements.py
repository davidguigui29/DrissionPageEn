...
def get_frame(owner, loc_ind_ele, timeout=None):
    if isinstance(loc_ind_ele, str):
        ...
        if ele and ele._type != 'ChromiumFrame':
            raise TypeError('The locator does not refer to a frame element.')
        r = ele
        ...
        raise TypeError('One of the locator, iframe number, id, name, or ChromiumFrame object must be passed in.')
...
def _search_one(_list, index=1, displayed=None, checked=None, selected=None, enabled=None, clickable=None,
    ...
    :param checked: whether to be selected, bool, None to ignore this item
    :param selected: whether to be selected, bool, None to ignore this item
    :param enabled: whether to be available, bool, None to ignore this item
    :param clickable: whether to be clickable, bool, None to ignore this item
    :param have_rect: whether to have size and position, bool, None to ignore this item
    :param have_text: whether to contain text, bool, None to ignore this item
    :param tag: element type
    :return: filter results
    """
    num = 0
