...
class SessionOptions(object):
    ...
    def __init__(self, read_file=True, ini_path=None):
        ...
        self._download_path = '.'
        self._timeout = 10
        self._del_set = set()  # Record the parameters to be deleted from the ini file
    ...
    # ===========Items to be processed independently begin============
    @property
    ...
    # ===========End of items to be processed independently============
