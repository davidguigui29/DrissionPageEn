...
class OptionsManager(object):
    """Class for managing configuration file contents"""
    ...
    def save(self, path=None):
        ...
        if path == 'default':
            ...
            if self.ini_path is None:
                raise ValueError('ini_path is not set.')
        ...
        print(f'Configuration saved to file: {path}')
        if path == str(default_path):
            print('The program can then automatically load the configuration from the file.')
