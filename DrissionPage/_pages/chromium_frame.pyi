...
class ChromiumFrame(ChromiumBase):
    ...
    def __init__(self,
                 ...
                 info: dict = None):
        """
        :param owner: the page object where the frame is located
        :param ele: the element where the frame is located
        :param info: the element information where the frame is located
        """
        ...
